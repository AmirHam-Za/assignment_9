<!-- /********************************************************************
 ...
 1) First  call search and category  using getPostKeyWord() function
 2) fetch data by "mysquli_fetch_array()" method using if and while condition.
 3) Then echo title , category, cinntent etc.
...
<section class="text-gray-600 body-font  min-h-[80vh] blogContent">
